...
class Moneris_Transaction
{
	...
	public function to_xml()
	{
		...
		$type_allows_efraud = in_array($params['type'], array('purchase', 'res_purchase_cc', 'res_add_token', 'preauth', 'res_preauth_cc', 'card_verification', 'cavv_purchase', 'cavv_preauth'));
